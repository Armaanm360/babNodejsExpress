...
ResMsg.HTTP_NOT_FOUND = 'The requested page could not be found but may be available again in the future';
...
ResMsg.HTTP_INTERNAL_SERVER_ERROR = '	A generic error message, given when no more specific message is suitable';
// without http
