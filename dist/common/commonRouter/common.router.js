...
const commmon_abstract_router_1 = __importDefault(require("../commonAbstract/commmon.abstract.router"));
const common_controller_1 = __importDefault(require("../commonController/common.controller"));
class CommonRouter extends commmon_abstract_router_1.default {
    constructor() {
        super();
