...
class AdminPermissionController extends abstract_controller_1.default {
    constructor() {
        ...
        this.createPermission = this.asyncWrapper.wrap((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const _d = yield this.adminPermissionsService.createPermission({
                group_id,
                name,
            }), { code } = _d, data = __rest(_d, ["code"]);
            yield this.createAudit(id, 'created permission. id: ' + ((_c = data.data) === null || _c === void 0 ? void 0 : _c.id), code);
            res.status(code).json(data);
        }));
    }
}
